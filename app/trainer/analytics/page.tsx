          ...
          <main className="p-6 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <LineChart className="h-5 w-5 text-blue-600" /> Revenue
                    Trend
                  </CardTitle>
                  <CardDescription>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <BarChart className="h-5 w-5 text-green-600" /> New Clients
                    Per Month
                  </CardTitle>
                  <CardDescription>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <BarChart className="h-5 w-5 text-pink-600" /> Package Sales
                    by Type
                  </CardTitle>
                  <CardDescription>
              ...
              <Card className="col-span-1 md:col-span-2 lg:col-span-1">
                <CardHeader>
                  ...
                  <CardDescription>
                    Clients who have spent the most
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>

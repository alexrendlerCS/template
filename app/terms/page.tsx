    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          By accessing or using the Fitness Trainer Scheduler platform, you
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Our platform provides tools and services for fitness trainers and
          clients to connect, schedule sessions, and manage their fitness
          journey. You agree to use the platform only for its intended purposes
        ...
        <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4">
          ...
          <li>You agree not to misuse or abuse our platform or services</li>
          <li>
            You will not attempt to circumvent any platform security measures
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          any activities or actions under your account. You must notify us
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Certain aspects of our service may require payment of fees. You agree
          to pay all applicable fees and taxes in connection with your
          activities on the platform. All payments are non-refundable unless
          otherwise specified.
        </p>
        <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          ...
          to our services immediately, without prior notice or liability, for

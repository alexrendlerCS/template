    ...
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          Welcome to Fitness Trainer Scheduler. We are committed to protecting
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4">
          ...
          <li>Profile information (fitness goals, health data, preferences)</li>
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground mb-4">
          We may use third-party services for various aspects of our platform,
          including payment processing and analytics. These providers have their
          own privacy policies and may collect and use your information
      ...
      <section className="mb-8">
        ...
        <p className="text-muted-foreground">
          Email: privacy@fitnesstrainerscheduler.com
          <br />
